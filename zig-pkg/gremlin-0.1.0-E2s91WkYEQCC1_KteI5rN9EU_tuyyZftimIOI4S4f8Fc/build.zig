...
// ProtoGenStep disabled for Zig 0.16
const ProtoGenStep = struct { step: std.Build.Step, pub fn create(_: *std.Build, _: anytype) *@This() { unreachable; } };
