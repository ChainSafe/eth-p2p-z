...
// pub const dynamic = xev.dynamic; // disabled for Zig 0.16
...
// pub const Dynamic = DynamicXev(Backend.candidates()); // disabled for Zig 0.16
// pub const DynamicXev = @import("dynamic.zig").Xev; // disabled for Zig 0.16
...
test {
    ...
    _ = ThreadPool;
    // _ = Dynamic; // disabled for Zig 0.16
